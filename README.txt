...
The favicon/* icons were generated by https://realfavicongenerator.net: I
created an icon in Inkscape, uploaded, configured settings, and then downloaded
...
the files in sub dir /favicon/ instead: (for simpler Nginx config)
